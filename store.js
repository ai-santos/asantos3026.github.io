...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/AILEEN-PROGRAMMING-STUDY-LIST/"
    })
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: "https://listalous.herokuapp.com/lists/AILEEN-PROGRAMMING-STUDY-LIST/items/" + itemId,
